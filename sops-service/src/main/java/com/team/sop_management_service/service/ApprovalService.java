...
//
//                log.info("Updating SOP status: id={}, newStatus={}", sop.getId(), newStatus);
//
//                SOPCreation updatedSop = sopRepository.save(sop);
//                log.info("SOP {}: id={}, title={}", isApproved ? "approved" : "rejected", updatedSop.getId(), updatedSop.getTitle());
//
//                return updatedSop;
//            } catch (Exception e) {
//                log.error("Error during SOP approval/rejection process", e);
